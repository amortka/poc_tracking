...
export const visualizationSceneMock: IVisualizationScene = {
  ...
  paths: {
    ojihoybn: {
      ...
      sensors: [
        ...
        { sensorId: 'dqwzllxi', distance: 0.398 },
        { sensorId: 'sadvcvxl', distance: 0.553 },
        { sensorId: 'ccomdgqr', distance: 0.608 },
  ...
  points: {
    ...
    etkehdxr: { x: 4.705793638170467, y: 0.2905774494101239 },
    rzmgfdlc: { x: 3.1931721721836617, y: 0.29531920949158724 },
    dqwzllxi: { x: 1.7, y: 2.088939798575024 },
    sadvcvxl: { x: 3.1526618933650417, y: 5.063378283472941 },
    ccomdgqr: { x: 4.722366882605707, y: 5.067028760192106 },
